...
export default @pageWithData('orderDetail')
@connect(({ orderDetail }) => ({
  ...orderDetail
}))
    ...
    return <View className="order">
        {loading ? <Loading height="100vh" /> : <View className="body">
            <View className="order">
              ...
              {(orderView.expressStatus === 2 || orderView.expressStatus === 3) && <View className="address-section">
              ...
              {orderView.expressStatus === 3 && <View className="parcel-info-section">
                  <View className="orderBorder" />
            ...
            {orderView.expressStatus === 1 && <Button onClick={this.applyDelivery.bind(this)} className="apply-delivery" hoverClass="button-hover">
                申请发货
              </Button>}
          </View>}
      </View>;
