...
export default @pageWithData('mine')
...
class extends PureComponent {
  ...
  render() {
    ...
    return <block>
        {loading ? <Loading height="100vh" /> : <View className="body">
            {!userInfo && <Button onGetUserInfo="onGetUserInfo" className="section userinfo" openType="getUserInfo">
            ...
            {userInfo && <View className="section userinfo">
                <Text className="name">{userInfo.nickName}</Text>
                <Image className="avatar avatar-logined" lazyLoad mode="aspectFill" src={userInfo.avatarUrl} />
              </View>}
            ...
            <View className="section functions">
              ...
              {isAndroid(system) && <View className="function function-2">
            ...
            <Form onSubmit={this.saveFormID.bind(this)} reportSubmit="true">
              <Button onGetUserInfo={this.onGetUserInfo.bind(this)} data-type="handleGoOrder" className="section bar" formType="submit" hoverClass="hover" openType="getUserInfo">
            ...
            <View className="sectionBorder" />
            <Form onSubmit={this.saveFormID.bind(this)} reportSubmit="true">
              <Button onClick={this.startConversation.bind(this)} className="section bar" formType="submit" hoverClass="hover">
                <Text className="title">联系客服</Text>
                <Text className="iconfont icon-arrow-right" />
              </Button>
            </Form>
            <Form onSubmit={this.saveFormID.bind(this)} reportSubmit="true">
              <Button onClick={this.shareGetCoin.bind(this)} className="section bar" formType="submit" hoverClass="hover">
