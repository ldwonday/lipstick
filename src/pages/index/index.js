          ...
          <View className="products">
            <View className="container">
              ...
              <View className="banner">
                <Image
                  onClick={this.bannerTapped.bind(this)}
                  className={`slide-image`}
                  data-url={configViews.tuwen_url}
                  mode="aspectFill"
                  src={configViews.list_banner}
                />
              </View>
              <View className="middle">
                ...
                {!isAndroid(system) && (
                  <Text onClick={this.enterHelp.bind(this)} className="balance">闯关说明</Text>
                )}
                <Form onSubmit={this.saveFormID.bind(this)} reportSubmit="true">
              ...
              {lipsticks.length < 1 &&
                loading && (
                  <View className="lipsticks-out-stock">
                    <View className="tip">
                          ...
                          {isAndroid(system) && (
                            <Form onSubmit={this.saveFormID.bind(this)} reportSubmit="true">
                              <Button
                                ...
                                data-type="startPlay"
                                catchtap="disable"
                                className="lipstick-button"
                                data-item={item.id}
                                data-price={item.game_price}
                                formType="submit"
                                hoverClass="hover"
                                openType="getUserInfo"
                              >
            ...
            {showDialogLessCoins && (
              <View className="dialog dialog-less-coins" onTouchMove={this.handleOnTouchMove.bind(this)}>
                <View className="dialog-box">
                  <Image
                    onClick={this.closeDialogLessMoney.bind(this)}
                    className="close"
                    mode="aspectFill"
                    src={closeBtn}
                  />
            ...
            {showDialogLipstick && (
              <View className="dialog dialog-lipstick" onTouchMove={this.handleOnTouchMove.bind(this)}>
                <View className="dialog-box">
                  <Image
                    onClick={this.closeLipstick.bind(this)}
                    className="close"
                    mode="aspectFill"
                    src={closeBtn}
                  />
                  ...
                  {isAndroid(system) && (
                    <Form onSubmit={this.saveFormID.bind(this)} reportSubmit="true">
                      <Button
                        ...
                        data-type="startPlay"
                        className="pay"
                        data-item={lipstickChoosen.id}
                        data-price={lipstickChoosen.gamePrice}
                        formType="submit"
                        hoverClass="hover"
                        openType="getUserInfo"
                      >
            ...
            {showDialogTopup && (
              <View className="dialog dialog-topup" onTouchMove={this.handleOnTouchMove.bind(this)}>
                <View className="dialog-box">
                  <Image
                    onClick={this.closeDialogTopup.bind(this)}
                    className="close"
                    mode="aspectFill"
                    src={closeBtn}
                  />
                  ...
                  <View className="topup-blocks">
                    {payList &&
                      payList.map(item => {
                        return (
                          <Form onSubmit={this.topUpCoins.bind(this)} reportSubmit="true" key={item.id}>
                            <Button
                              className="pay"
                              data-id={item.id}
                              formType="submit"
            ...
            <Form onSubmit={this.saveFormID.bind(this)} reportSubmit="true">
              <Button
                onGetUserInfo={this.onGetUserInfo.bind(this)}
                data-type="gameTrial"
                className={`trial ${isTouching ? 'deactive' : ''}`}
                formType="submit"
                openType="getUserInfo"
              >
